...
async def get_questions(
    ...
    print(f"User: {user}")
    print(
        f"User id: {user.id}, username: {user.username}, first_name: {user.first_name}, last_name: {user.last_name}, language_code: {user.language_code}, allows_write_to_pm: {user.allows_write_to_pm}, photo_url: {user.photo_url}"
    )
    questions = [
        {
            "question_id": 1,
