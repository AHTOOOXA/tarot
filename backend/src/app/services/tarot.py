...
from app.schemas.tarot import SpreadType, TarotCard, TarotReading, TarotSpread
...
class TarotService(BaseService):
    ...
    async def generate_interpretation(
        self, spread: TarotSpread, cards: List[TarotCard], question: Optional[str]
    ) -> str:
    ...
    def _build_interpretation_prompt(self, spread: TarotSpread, cards: List[TarotCard], question: Optional[str]) -> str:
    ...
    async def create_reading(
        self, user_id: int, spread_type: SpreadType, question: Optional[str] = None
    ) -> TarotReading:
